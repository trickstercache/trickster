...
func (c *Client) ProxyHandler(w http.ResponseWriter, r *http.Request) {
	engines.ProxyRequest(model.NewRequest(c.name, otPrometheus, "ProxyHandler", r.Method, c.BuildUpstreamURL(r), r.Header, c.config.Timeout, r, c.webClient), w, c.Logger())
}
