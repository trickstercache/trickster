...
func TestTypeToFieldDataType(t *testing.T) {
	tests := map[string]timeseries.FieldDataType{
		...
		"Nullable(Float64)":               timeseries.Float64,
		"LowCardinality(String)":          timeseries.String,
		"LowCardinality(Nullable(UInt8))": timeseries.Uint64,
		"Date32":                          timeseries.DateSQL,
		"Bool":                            timeseries.Bool,
		"IPv4":                            timeseries.String,
		"IPv6":                            timeseries.String,
		"Int128":                          timeseries.String,
		"UInt256":                         timeseries.String,
		"Enum8('a' = 1, 'b' = 2)":         timeseries.String,
		"Array(UInt8)":                    timeseries.Unknown,
	}
