...
func marshalTimeseriesCSVWithNames(ds *dataset.DataSet, rlo *timeseries.RequestOptions, w io.Writer) error {
	return nil
}

func marshalTimeseriesTSV(ds *dataset.DataSet, rlo *timeseries.RequestOptions, w io.Writer) error {
	return nil
}

func marshalTimeseriesTSVWithNames(ds *dataset.DataSet, rlo *timeseries.RequestOptions, w io.Writer) error {
	return nil
}

func marshalTimeseriesTSVWithNamesAndTypes(ds *dataset.DataSet, rlo *timeseries.RequestOptions, w io.Writer) error {
	return nil
}
...
// /*
// {"meta":[{"name":"t","type":"UInt64"},{"name":"cnt","type":"UInt64"}{"name":"meta1","type":"UInt16"},{"name":"meta2","type":"String"}]"data":[{"cnt":"12648509","meta1":200,"meta2":"value2","t":"1557766080000"},{"cnt":"10260032","meta1":200,"meta2":"value3","t":"1557766680000"},{"cnt":"1","meta1":206,"meta2":"value3","t":"1557767280000"}],"rows":3}
// */
