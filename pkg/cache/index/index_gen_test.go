...
func TestMarshalUnmarshalIndexObjects(t *testing.T) {
	v := IndexObjects{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgIndexObjects(b *testing.B) {
	v := IndexObjects{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgIndexObjects(b *testing.B) {
	v := IndexObjects{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalIndexObjects(b *testing.B) {
	v := IndexObjects{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeIndexObjects(t *testing.T) {
	v := IndexObjects{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeIndexObjects Msgsize() is inaccurate")
	}
...
func BenchmarkEncodeIndexObjects(b *testing.B) {
	v := IndexObjects{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeIndexObjects(b *testing.B) {
	v := IndexObjects{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
