...
func TestNewAccelerator(t *testing.T) {
	h, err := NewAccelerator("http://127.0.0.1:8123")
	if err != nil {
...
func TestNewAcceleratorWithOptions(t *testing.T) {
	...
	c := co.New()
	c.Name = "ch-cache"
	h, err := NewAcceleratorWithOptions("http://127.0.0.1:8123/ch", o, c)
	if err != nil {
...
func TestNewAcceleratorCacheConnectError(t *testing.T) {
	...
	_, err := NewAcceleratorWithOptions("http://127.0.0.1:8123", nil, c)
	if err == nil {
...
func TestNewAcceleratorClientError(t *testing.T) {
	...
	_, err := NewAcceleratorWithOptions("http://127.0.0.1:8123", o, nil)
	if err == nil {
