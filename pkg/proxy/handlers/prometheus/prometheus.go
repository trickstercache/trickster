...
import (
	...
	prommodel "github.com/tricksterproxy/trickster/pkg/proxy/origins/prometheus/model"
...
func NewAccelerator(baseURL string, o *oo.Options, c *co.Options) (http.Handler, error) {
	...
	o.PathPrefix = u.Path
	r := mux.NewRouter()
	cl, err := prometheus.NewClient("default", oo.New(), mux.NewRouter(), cache, prommodel.NewModeler())
	if err != nil {
		return nil, err
	}
