...
func TestNewAccelerator(t *testing.T) {
	h, err := NewAccelerator("http://127.0.0.1:9090/prometheus")
	if err != nil {
...
func TestNewAcceleratorWithOptions(t *testing.T) {
	...
	c := co.New()
	c.Name = "prom-cache"
	h, err := NewAcceleratorWithOptions("http://127.0.0.1:9090", o, c)
	if err != nil {
...
func TestNewAcceleratorCacheConnectError(t *testing.T) {
	...
	_, err := NewAcceleratorWithOptions("http://127.0.0.1:9090", nil, c)
	if err == nil {
...
func TestNewAcceleratorClientError(t *testing.T) {
	...
	_, err := NewAcceleratorWithOptions("http://127.0.0.1:9090", o, nil)
	if err == nil {
